...
struct InputFlow : public Analyzer
{
    ...
    virtual void move(MemPtr dst, MemPtr ptr, std::size_t count);
    virtual void clear(MemPtr dst, std::size_t count);
    virtual void join(MemPtr dst, std::size_t count, std::vector<std::pair<MemPtr, std::size_t> > const& memory);
    ...
    virtual void join_per_byte(MemPtr dst, MemPtr src1, MemPtr src2, std::size_t count);
    virtual void join_extend(MemPtr dst, std::size_t dst_count, MemPtr src, std::size_t src_count);
    virtual void extend_signed(MemPtr dst, std::size_t dst_count, MemPtr src, std::size_t src_count);
    virtual void extend_unsigned(MemPtr dst, std::size_t dst_count, MemPtr src, std::size_t src_count);
...
protected:
    ...
    void __development__crash_execution(std::string const& message);
